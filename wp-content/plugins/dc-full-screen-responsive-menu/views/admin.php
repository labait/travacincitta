...
$mid='';
$author_show = 1;
$author_desc = 'Author @DARTCreations <a href="https://www.dart-creations.com">WordPress Full Screen Menu by DART Creations</a>';
$bgcolor = '#81d742';
$txtcolor = '#000000';
$txtfont = 'Exo';
  ...
  <table class="form-table">
    <tbody>
      ...
      <tr>
        ...
        <td><input type="hidden"  value='Author @DARTCreations WordPress Full Screen Menu by <a href="https://www.dart-creations.com">DART-Creations.com</a>' id="menu_author_desc" name="menu_author_desc" size="115"></td>
      </tr>
      <tr>
